...
def process_image(item, item_path, normalized_item, source_folder):
    ...
    shutil.move(item_path, os.path.join(images_folder, normalized_item))
...
def process_video(item, item_path, normalized_item, source_folder):
    ...
    shutil.move(item_path, os.path.join(video_folder, normalized_item))
...
def process_document(item, item_path, normalized_item, source_folder):
    ...
    shutil.move(item_path, os.path.join(documents_folder, normalized_item))
...
def process_audio(item, item_path, normalized_item, source_folder):
    ...
    shutil.move(item_path, os.path.join(audio_folder, normalized_item))
...
def process_archive(item, item_path, normalized_item, source_folder):
    ...
    archive_folder = os.path.join(archives_folder, normalized_item.rsplit('.', 1)[0])
...
def process_other(item, item_path, normalized_item, source_folder):
    ...
    others.append(item)
    shutil.move(item_path, os.path.join(others_folder, normalized_item))
...
def process_folder(folder):
    for item in os.listdir(folder):
        ...
        if os.path.isfile(item_path):
            ...
            processor(item, item_path, normalized_item, folder)
